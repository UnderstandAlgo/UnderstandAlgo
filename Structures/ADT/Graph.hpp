...
public:
    ...
    */
    [[maybe_unused]] virtual void addEdge(const VerticeType &source, const VerticeType &destination, const EdgeType &weight) = 0;
    ...
    */
    [[maybe_unused]] virtual void addEdge(const VerticeType& source, const VerticeType& destination,
...
public:
    ...
    [[nodiscard]] unsigned int numVertices() const override; // Overridden numVertices() function
    [[nodiscard]] unsigned int numEdges() const override; // Overridden numEdges() function
